		...
		<div class="common_table_summit">
			<table>
				...
				<tbody>
					<tr>
						<th>userId :</th>
						<th class="wd110"><input class="wd100" name="userId"
							value="${userId        }" /></th>
						<%-- 
			<th>userName       :</th><th class="wd110"><input class="wd100" name="userName"       value="${userName      }"/></th> --%>
						<th>userPhone :</th>
						<th class="wd110"><input class="wd100" name="userPhone"
							value="${userPhone     }" /></th>
						<th>userEmail :</th>
						<th class="wd110"><input class="wd100" name="userEmail"
							value="${userEmail     }" /></th>
						<th><input type="submit" class="btn_common_red_2" value="검색">
						<input type="button" id="openWrite" class="btn_common_red_2" value="글쓰기"></th>
					</tr>
					<%-- 
